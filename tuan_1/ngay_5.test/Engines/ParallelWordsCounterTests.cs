...
{
    public class ParallelWordsCounterTests
    {
        // ParallelWordsCounter_Execute_Test
        ...
        public void Execute_LinesOfLogType_ReturnDictionaryOfLogType()
        {
            ...
            var logger = factory.CreateLogger<ParallelWordsCounter>();

            // Arrange
            var counter = new ParallelWordsCounter();
